  ...
  pkgs = hackage:
    {
      packages = {
        ...
        "tasty-bench".revision = (((hackage."tasty-bench")."0.3.1").revisions).default;
        "tasty-bench".flags.tasty = true;
        "tasty-bench".flags.debug = false;
        ...
        "inline-r".revision = (((hackage."inline-r")."0.10.5").revisions).default;
        ...
        "hspec-discover".revision = (((hackage."hspec-discover")."2.9.1").revisions).default;
        ...
        "hspec-core".revision = (((hackage."hspec-core")."2.9.1").revisions).default;
        ...
        "hspec".revision = (((hackage."hspec")."2.9.1").revisions).default;
